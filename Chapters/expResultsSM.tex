...
\begin{figure}
\center
\subfloat[RNN Confusion Matrix]{\includegraphics[width=6.5cm,height=3.5cm]{Figures/cmRNN.JPG}} 
\subfloat[RNN Normalized Confusion Matrix]{\includegraphics[width=6.5cm,height=3.5cm]{Figures/cmnRNN.JPG}}\\
\subfloat[RNN Classification Report]{\includegraphics[width=8.5cm,height=3.5cm]{Figures/reportRNN.JPG}}
\caption{RNN Results}
...
\begin{figure}
\center
\subfloat[SVM Confusion Matrix]{\includegraphics[width=6.5cm,height=3.5cm]{Figures/cmSVM.JPG}} 
\subfloat[SVM Normalized Confusion Matrix]{\includegraphics[width=6.5cm,height=3.5cm]{Figures/cmnSVM.JPG}}\\
\subfloat[SVM Classification Report]{\includegraphics[width=8.5cm,height=3.5cm]{Figures/reportSVM.JPG}}
\caption{SVM Results}
...
\begin{figure}
\center
\subfloat[NN Confusion Matrix]{\includegraphics[width=6.5cm,height=3.5cm]{Figures/cmNN.JPG}} 
\subfloat[NN Normalized Confusion Matrix]{\includegraphics[width=6.5cm,height=3.5cm]{Figures/cmnNN.JPG}}\\
\subfloat[NN Classification Report]{\includegraphics[width=6.5cm,height=3.5cm]{Figures/reportNN.JPG}}
\caption{NN Results}
\label{fig:resultsNN}
\end{figure}
...
\begin{figure}
\center
\subfloat[Precision]{\includegraphics[width=5cm,height=3.5cm]{Figures/precision.JPG}} 
\subfloat[Recall]{\includegraphics[width=5cm,height=3.5cm]{Figures/recall.JPG}}
\subfloat[F1 Score]{\includegraphics[width=5cm,height=3.5cm]{Figures/F1_Score.JPG}}
