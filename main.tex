...
\begin{document}
	...
	% CONTENT
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	 \include{Chapters/introductionSM}
	\include{Chapters/theorySM}
    \include{Chapters/developmentSM}
    \include{Chapters/methodologySM}
    \include{Chapters/expResultsSM}
    \include{Chapters/conclusionsSM}
